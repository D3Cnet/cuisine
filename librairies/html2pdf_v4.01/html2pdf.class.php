...
//				$this->maxX = max($this->maxX, $x+$w);
		...
		*/	
		protected function c_TD($param)
		{
			...
			if ($this->sub_part)
			{
// TODO DCA On force testTDin1page à false pour empecher que 
// $this->sub_html->pdf->getPage() ne renvoie un nombre erroné de page (2 au lieu de 1)
// et bloque la génération du PDF. erreur uniquement en PHP v5.1.6, ne se produit pas en PHP v5.3.0
// La version 5.9.073 de TCPDF (librairie de HTML2PDF) ne corrige pas le probleme.
// echo ($this->testTDin1page.'---'.$this->sub_html->pdf->getPage());
				$this->testTDin1page = false;
// Fin TODO
